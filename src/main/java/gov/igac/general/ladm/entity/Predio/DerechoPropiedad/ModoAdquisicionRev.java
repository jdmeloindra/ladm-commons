...
@NoArgsConstructor
@Entity
@Table(name = "MODO_ADQUISICION", schema="SNC_LADM")
public class ModoAdquisicionRev {
...
//	@OneToMany(mappedBy="modoAdquisicion", cascade=CascadeType.MERGE, fetch=FetchType.LAZY)
